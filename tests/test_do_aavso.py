...
class TestDoAAVSO(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        do_calibration.add_catalog_data_to_sd(self.sd, 10, 0.1, "UCAC4-Numero2391", "UCAC4", self.sd.coords)
        self.sd_comp1 = stardesc(1, 10, 10)
        do_calibration.add_catalog_data_to_sd(self.sd_comp1, 12.1, 0.1, "UCAC4-Numero1", "UCAC4", self.sd.coords)
        self.sd_comp5 = stardesc(5, 10, 10)
        do_calibration.add_catalog_data_to_sd(self.sd_comp5, 11.1, 0.1, "UCAC4-Numero5", "UCAC4", self.sd.coords)
        ...
        #                 comp_catalogerr)
        observations = [{'2457236.66302': (12.2, 0.01)}, {'2457236.66302': (11.2, 0.01)}]
        ...
        try:
            ...
            with open(aavso_out_txt, 'w') as fp:
                writer = aavso.ExtendedFormatWriter(fp, 'RMH', software='munipack-automation', type='EXTENDED',
                                                    obstype='CCD', location=(self.settings['sitelat'],
