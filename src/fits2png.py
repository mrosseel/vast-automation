...
def process_fits(
    data_dir: Path, result_dir: Path, start: str, end: str, extension="*.fit"
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--start", help="The start Julian Date", nargs="?", required=True
    )
    parser.add_argument(
        "-e", "--end", help="The end Julian Date", nargs="?", required=True
    )
    parser.add_argument(
