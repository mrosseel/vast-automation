...
def write_match(to_match_photomotry_file, base_photometry_file, to_match_is_full_path=False,
                config_file=init.basedir + 'match.conf', inputdir=init.photometrydir,
                outputdir=init.matchedphotometrydir):
...
if __name__ == '__main__':
    ...
    if args.chart:
        ...
        run_do_rest(init.do_convert_fits, init.do_photometry, init.do_match, init.do_compstars,
