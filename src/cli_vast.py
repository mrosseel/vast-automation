...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-!",
        "--allstars",
        help="Generate phase/light/aavso for all stars. WARNING: takes long",
        action="store_true",
    )
    parser.add_argument(
        "-f",
    ...
    parser.add_argument(
        "-c",
        "--candidates",
        help="Generate phase diagrams for autocandidates",
        action="store_true",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--selectvsx",
        help="Add all VSX stars to the selected stars",
        action="store_true",
    )
    parser.add_argument(
        "--selectcandidates",
        help="Add all candidate stars to the selected stars",
        action="store_true",
    )
